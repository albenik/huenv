...
func TestGenerateConfigFuncSource(t *testing.T) {
	const expectedOutput = `// DO NOT EDIT! Code generated by github.com/albenik/huenv/cmd/huenv@%s.
...
`
	...
	assert.Equal(t, fmt.Sprintf(expectedOutput, version.String()), buf.String())
}
